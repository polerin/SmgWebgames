class InjectionRequest extends Event {
...
InjectionRequest.EVENT_NAME = 'InjectionRequestEvent';

class FindGameRequest extends Event {
    constructor(player) {
        super(FindGameRequest.EVENT_NAME);
        this.player = player;
    }
}
FindGameRequest.EVENT_NAME = 'FindGameRequest';

function requestDependencies(element, requestedToken) {
...
function injectionResolverFactory(container) {
    return (request) => container.resolve(request.token);
}
...
function token(options) {
    const normalized = { description: options } ;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const s=(i,t)=>{const e=i._$AN;if(void 0===e)return !1;for(const i of e)i._$AO?.(t,!1),s(i,t);return !0},o$2=i=>{let t,e;do{if(void 0===(t=i._$AM))break;e=t._$AN,e.delete(i),i=t;}while(0===e?.size)},r$2=i=>{for(let t;t=i._$AM;i=t){let e=t._$AN;if(void 0===e)t._$AN=e=new Set;else if(e.has(i))break;e.add(i),c(t);}};function h$1(i){void 0!==this._$AN?(o$2(this),this._$AM=i,r$2(this)):this._$AM=i;}function n$2(i,t=!1,e=0){const r=this._$AH,h=this._$AN;if(void 0!==h&&0!==h.size)if(t)if(Array.isArray(r))for(let i=e;i<r.length;i++)s(r[i],!1),o$2(r[i]);else null!=r&&(s(r,!1),o$2(r));else s(this,i);}const c=i=>{i.type==t$1.CHILD&&(i._$AP??=n$2,i._$AQ??=h$1);};class f extends i{constructor(){super(...arguments),this._$AN=void 0;}_$AT(i,t,e){super._$AT(i,t,e),r$2(this),this.isConnected=i._$AU;}_$AO(i,t=!0){i!==this.isConnected&&(this.isConnected=i,i?this.reconnected?.():this.disconnected?.()),t&&(s(this,i),o$2(this));}setValue(t){if(f$1(this._$Ct))this._$Ct._$AI(t,this);else {const i=[...this._$Ct._$AH];i[this._$Ci]=t,this._$Ct._$AI(i,this,0);}}disconnected(){}reconnected(){}}
...
let WelcomeMenu = class WelcomeMenu extends Menu {
    constructor() {
        super(...arguments);
    ...
    connectedCallback() {
        requestDependencies(this, WelcomeMenuToken)
            .then((deps) => this.inject(deps))
            .catch((e) => console.error("Unable to retrieve dependencies for Welcome Menu", e));
    }
    inject(deps) {
    ...
    render() {
        ...
        return x `<div class="menu_container menu_container--welcome">
            ...
            <button @click=${(e) => this.handleFindGameClick(e)}>Find Game</button>
        </div>`;
    }
    firstUpdated(_changedProperties) {
        this.nameInput.value?.focus();
    }
    handleFindGameClick(e) {
...
export { Menu as BaseMenu, FindGameRequest, InjectionRequest, WelcomeController, WelcomeMenu$1 as WelcomeMenu, WelcomeMenuToken, injectionResolverFactory, registerMenuElements, requestDependencies };
